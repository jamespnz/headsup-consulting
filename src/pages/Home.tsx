    ...
    <main>
      ...
      <section className="py-24 bg-neutral-50 border-y border-neutral-200">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="section-label mb-6">Studio Identity</p>
              <h2 className="text-3xl font-semibold text-neutral-900 mb-6">Operating from Japan</h2>
              <div className="space-y-4 text-neutral-500 leading-relaxed">
                <p>
                  HeadsUp Consulting is a boutique systems architecture and AI product studio operating from Japan, with App Design Studio as its internal product development unit.
                </p>
                <p>
                  Based in Kawasaki and engaged with the Tokyo tech ecosystem, the studio is available for systems architecture and AI product work across Japan and APAC.
                </p>
              </div>
              <div className="mt-8">
                <Link to="/about" className="btn-secondary">
            ...
            <div className="space-y-0">
              {[
                { period: 'Current', label: 'Kawasaki, Japan', desc: 'Building AI products and refining architecture patterns from Japan.' },
                { period: 'Active', label: 'Tokyo Ecosystem', desc: 'Engaged with the Tokyo tech ecosystem — events, partnerships, and collaborations.' },
                { period: 'Open', label: 'Japan & APAC', desc: 'Available for systems architecture and AI product work across Japan and APAC.' },
              ].map((item, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-neutral-500 mb-8 max-w-md mx-auto">
            Available for architecture consulting, AI product advisory, and systems design engagements across Japan and APAC.
          </p>
