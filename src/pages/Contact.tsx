      ...
      <section className="py-20 bg-neutral-950 text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-lg text-neutral-400 max-w-xl leading-relaxed">
            Available for systems architecture and AI product work across Japan and APAC. Reach out to start a conversation.
          </p>
        </div>
      </section>
              ...
              <div className="border-t border-neutral-200 pt-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm text-neutral-700 font-medium">Currently based in Kawasaki, Japan</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm text-neutral-600">Available across Japan and APAC</span>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} noValidate>
                  ...
                  <div className="mb-5">
                    ...
                    >
                      ...
                      <option value="expo">Tokyo Ecosystem — Connect</option>
