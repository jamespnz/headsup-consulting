          ...
          <div className="flex items-start gap-5 p-6 border border-neutral-200 rounded-sm bg-neutral-50">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 leading-relaxed max-w-2xl">
                The Insights section is currently being drafted. The articles below represent planned topics. Check back soon or reach out directly to discuss these themes.
              </p>
            </div>
          </div>
        </div>
