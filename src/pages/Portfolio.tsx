...
const products = [
  ...
  {
    id: 'nz-build-guardian',
    label: 'Sector Product',
    name: 'NZ-Build-Guardian',
    tagline: 'Stateful forensic audit automation for the New Zealand construction sector',
    description: 'Real-time NZBC compliance tracking, quantity surveying ledger isolation, and commercial value-at-risk gating — engineered for NZIQS professionals, developers, and academic evaluations.',
    status: 'In Development',
    tags: ['NZBC', 'Forensic Audit', 'Construction', 'Compliance', 'Risk Gating'],
    path: '/portfolio/nz-build-guardian',
  },
  {
    id: 'baking-hydration-calculator',
    label: 'Micro-Utility',
    name: 'Baking Hydration Calculator',
    tagline: "Baker's percentage, batch scaling, and preferment hydration in one page",
    description: 'A focused single-page tool for computing baker\'s percentages, scaling batches, and accounting for preferment hydration — fast, accurate, shareable math without a spreadsheet.',
    status: 'Live',
    tags: ['Baker\'s Percent', 'Unit Conversion', 'Single-Page'],
    path: '/portfolio/baking-hydration-calculator',
  },
  {
    id: 'spacing-calculator',
    label: 'Micro-Utility',
    name: 'Spacing Calculator',
    tagline: 'Even division of a fixed length into precise, previewable segments',
    description: 'A focused single-page tool for dividing a fixed length into evenly spaced segments — with live preview, unit conversion, and shareable state for designers, builders, and makers.',
    status: 'Live',
    tags: ['Equal Division', 'Unit Conversion', 'Live Preview'],
    path: '/portfolio/spacing-calculator',
  },
  {
