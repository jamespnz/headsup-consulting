...
import NZBuildGuardian from './pages/portfolio/NZBuildGuardian';
import BakingHydrationCalculator from './pages/portfolio/BakingHydrationCalculator';
import SpacingCalculator from './pages/portfolio/SpacingCalculator';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/portfolio/nz-build-guardian" element={<NZBuildGuardian />} />
        <Route path="/portfolio/baking-hydration-calculator" element={<BakingHydrationCalculator />} />
        <Route path="/portfolio/spacing-calculator" element={<SpacingCalculator />} />
